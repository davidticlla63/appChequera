...
@ConversationScoped
public class RegistroChequesController implements Serializable {
	...
	public void registrarMovimientoCuenta() {
		...
		if (this.selectedChequera.getCuenta().getTipoMoneda()
				.equals("BOLIVIANOS")) {
			...
			this.newMovimientoCuentas.setSaldo(this.newMovimientoCuentas
					.getMontoNacional());
		} else if (this.selectedChequera.getCuenta().getTipoMoneda()
				.equals("EXTRANJERA")) {
			this.newMovimientoCuentas.setMontoExtranjero(this.totalNacional);
			this.newMovimientoCuentas.setMontoNacional(this.totalNacional
					* this.newMovimientoCuentas.getTipoCambio());
		...
		this.newMovimientoCuentas.setNumeroTransaccion(this.chequeraDao
				.obtenerChequera(this.selectedChequera).getSecuencia());
		...
		this.newMovimientoCuentas.setTipoMoneda(this.selectedChequera
				.getCuenta().getTipoMoneda());
		this.newMovimientoCuentas.setUsuarioRegistro(this.usuarioLogin
				.getLogin());
	...
	public void convertToLeteral() {
		this.totalLiteral = NumerosToLetras
				.convertNumberToLetterSM(this.totalNacional);
	}
