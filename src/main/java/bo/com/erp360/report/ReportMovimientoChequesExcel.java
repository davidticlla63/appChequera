...
public class ReportMovimientoChequesExcel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			try {
				...
				/*Integer pIdCuenta= Integer.parseInt(request.getParameter("pIdCuenta"));*/
				String pTipoReporte = request.getParameter("pTipoReporte");
				...
				/*parameters.put("ID_CUENTA", pIdCuenta);*/
				...
				String rutaReporte =  urlPath + "resources/report/tesoreria/reportCheques"+pTipoReporte+".jasper";
